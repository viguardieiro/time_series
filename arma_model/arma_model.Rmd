...
A série apresenta uma função de ACF que cai drasticamente após o lag 2, enquanto a PACF cai mais gradualmente, o que dá a noção de se tratar de um modelo MA(2). Utilizando dessa observação, fitamos:
