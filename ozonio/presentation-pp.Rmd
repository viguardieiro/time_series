...
- Results:
  ...
  - Poly 2: 0.004079873
  - Poly 3: 0.004562281
  - Arma(1, 0): 0.004675624
  - Holt: 0.004905350
  - HoltWinters additive: 0.005075887 
  - HoltWinters multiplicative: 0.005126882 
  - Naive: 0.005160706
...
temp <- predictions.test %>% group_by(ind) %>% summarise(Date.Local = mean(Date.Local),
                                                         pred = mean(pred),
                                                         low = min(low),
                                                         up = max(up))
